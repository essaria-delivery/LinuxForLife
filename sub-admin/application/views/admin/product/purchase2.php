                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title"> <?php echo $this->lang->line("List Purchase");?></h4>
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><?php echo $purchase->user_fullname; ?></td>                                                
                                                    <td class="text-center"><?php echo $purchase->product_name; ?></td>
                                                    <td class="text-center"><?php echo $purchase->qty; ?></td>
                                                    <td class="text-center"><?php echo $purchase->unit; ?></td>

                                                    <!--<td class="td-actions text-center"><div class="btn-group">-->
                                                    <!--        <?php echo anchor('admin/edit_purchase/'.$purchase->purchase_id,  '<button type="button" rel="tooltip" class="btn btn-success btn-round">-->
                                                    <!--        <i class="material-icons">edit</i>-->
                                                    <!--    </button>', array("class"=>"")); ?>-->

                                                    <!--        <?php echo anchor('admin/delete_purchase/'.$purchase->purchase_id, '<button type="button" rel="tooltip" class="btn btn-danger btn-round">-->
