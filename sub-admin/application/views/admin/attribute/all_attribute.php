                                                ...
                                                <?php foreach($allatt as $att){ ?>
                                                    <tr>
                                                        ...
                                                        <td class="td-actions text-center"><div class="">
                                                            <?php echo anchor('admin/edit_banner/'.'id',  '<button type="button" rel="tooltip" class="btn btn-success btn-round">
                                                                <i class="material-icons">edit</i>
                                                            </button>', array("class"=>"")); ?>

                                                            <?php echo anchor('admin/delete_banner/'.'id',  '<button type="button" rel="tooltip" class="btn btn-danger btn-round">
