                                ...
                                <div class="card-content">
                                    <h4 class="card-title"><?php echo $this->lang->line("Add Delivery Boy");?></h4>
                                        <div class="row"  style="padding-top:50px;">
                                            ...
                                            name="emp_fullname" class="form-control" placeholder="<?php echo $this->lang->line("Delivery Boy Name");?>" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" class="form-control" id="mobile" name="mobile" placeholder="<?php echo $this->lang->line("Mobile No");?>" />
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input class="form-control" type="password" id="user_password" name="user_password" placeholder="<?php echo $this->lang->line("Password");?>" />
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                           ...
                                           <?php 
                                                ...
                                                {?>
                                                <option value="<?= $store->user_id ?>"><?= $store->user_name ?> (<?= $store->user_fullname ?>)</option>
                                       ...
                                       <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input class="form-control" type="number"id="charge" name="charge" placeholder="<?php echo $this->lang->line("Service charge");?>" />
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div> 
