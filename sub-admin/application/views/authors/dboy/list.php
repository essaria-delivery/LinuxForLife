                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <a class="pull-right" href="<?php echo site_url("main/add_dboy"); ?>"><?php echo $this->lang->line("Add Delivery Boy");?></a>
                                                ...
                                                <?php foreach($users as $user){ ?>
                                                    <tr>
                                                        ...
                                                        <td class="td-actions text-center"><div class="btn-group">
                                                            <?php echo anchor('main/edit_dboy/'.$user->id, '<button type="button" rel="tooltip" class="btn btn-success btn-round">
                                                                <i class="material-icons">edit</i>
                                                            </button>', array("class"=>"")); ?>

                                                            <?php echo anchor('main/delete_dboy/'.$user->id, '<button type="button" rel="tooltip" class="btn btn-danger btn-round">
