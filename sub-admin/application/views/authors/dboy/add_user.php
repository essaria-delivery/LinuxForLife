...
<body>
    <div class="wrapper">
        ...
        <div class="main-panel" <?php if($this->session->userdata('language') == "arabic"){ echo 'style="float:left"'; } ?>>
                    ...
                    <form role="form" action="" method="post">
                              <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                    <div class="col-md-6">
                                        <input type="checkbox" class="form-control" id="status" name="status" style="width:50%;margin-top:30px"/>
                                    ...
                                    <div class="col-md-6">
                                        <label for="user_password" style="width:50%;margin-top:30px;">Store</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="charge" style="color:black;width:50%;margin-top:30px;">Service charge</label>
                                            <input type="number" class="form-control" id="charge" name="charge" placeholder="Service charge" />
                                        </div>
            ...
            <!-- Foot -->
            <?php  $this->load->view("authors/common/common_footer") ?>
        </div>
    </div>
    <!-- content -->
