                        ...
                        <div class="col-md-9">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title"><?php echo $this->lang->line("Edit Profile");?> </h4>
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left"><?php echo $this->lang->line("City");?>: *
                                            </label>
                                            <div class=" pac-card col-md-9" >
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input id="searchInput"  type="text"  name="city" class="form-control" placeholder="Enter a location" value="<?= $user->user_city; ?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="fileinput text-center fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail img-circle">
                                                    <img src="<?php echo $base.'uploads/profile/'.$user->user_image ?>" alt="">
                                                </div>
