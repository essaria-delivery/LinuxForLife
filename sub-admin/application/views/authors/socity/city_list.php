                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="row">
                                            <label class="col-md-3 label-on-left" style="padding:0px"><?php echo $this->lang->line("City Name");?></label>
                                            <div class="col-md-9">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-actions text-center">
                                                        <?php echo anchor('main/delete_city/'.$ct->city_id, '<button type="button" rel="tooltip" class="btn btn-danger btn-round">
