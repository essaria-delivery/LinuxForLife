                                                ...
                                                <?php foreach($socities as $socity){ ?>
                                                    <tr>
                                                        ...
                                                        <td class="td-actions text-right"><div class="btn-group">
                                                            <?php echo anchor('main/edit_socity/'.$socity->socity_id, '<button type="button" rel="tooltip" class="btn btn-success btn-round">
                                                                <i class="material-icons">edit</i>
                                                            </button>', array("class"=>"")); ?>

                                                            <?php echo anchor('main/delete_socity/'.$socity->socity_id, '<button type="button" rel="tooltip" class="btn btn-danger btn-round">
