                            ...
                            <div class="card">
                               ...
                               <?php if(isset($error) && $error!=""){ echo $error; } ?>
                                <div class="card-content">
                                    <h4 class="card-title"><?php echo $this->lang->line("ADD NEW STORE");?></h4>
                                        <div class="row"  style="padding-top:50px;">
                                            <label class="col-md-3 label-on-left"><?php echo $this->lang->line("Store Name");?> : *</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="user_fullname" class="form-control" placeholder="<?php echo $this->lang->line("Store Name");?>" required/>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label class="col-md-3 label-on-left"><?php echo $this->lang->line("Employe Name");?>:*</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="emp_fullname" class="form-control" placeholder="<?php echo $this->lang->line("Employe Name"); ?>" required/>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" class="form-control" name="mobile" placeholder="<?php echo $this->lang->line("Mobile No");?>" required/>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                         <div class="row">
                                             ...
                                             <div class=" pac-card col-md-9" >
                                                 <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                        <input id="searchInput"  type="text"  name="city" class="form-control" placeholder="Enter a location">
                                       ...
                                       <div id="map"  style="margin: 0px;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" class="form-control" name="percent" placeholder="<?php echo $this->lang->line("Profit Percent");?>" required/>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="email"  class="form-control" name="user_email" placeholder="user@gmail.com" required />
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input class="form-control" type="password" name="user_password" placeholder="<?php echo $this->lang->line("Password");?>" required/>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label class="col-md-3 label-on-left"><?php echo $this->lang->line("Delivery Range");?> :(in KM) *</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input class="form-control" type="number" name="delivery_range" placeholder="<?php echo $this->lang->line("Delivery Range");?>" required/>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div>
                                                <span class="btn btn-round btn-rose btn-file">
                                                    ...
                                                    <input type="hidden" value="" name=""><input type="file" name="pro_pic" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div>
                                                <span class="btn btn-round btn-rose btn-file">
                                                    <span class="fileinput-new"><?php echo $this->lang->line("Add Photo");?></span>
                                                    <span class="fileinput-exists"><?php echo $this->lang->line("Change");?></span>
                                                    <input type="hidden" value="" name=""><input type="file" name="main_banner" required>
                                                <div class="ripple-container"></div></span>
                                                <br>
                                                <a href="#pablo" class="btn btn-danger btn-round fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times"></i> Remove<div class="ripple-container"><div class="ripple ripple-on ripple-out" style="left: 58.6719px; top: 35px; background-color: rgb(255, 255, 255); transform: scale(15.5488);"></div></div></a>
                                            </div>
