...
// end mine products//
 ...
 function all_products_list(){
      ...
      function get_sale_orders($filter=""){
         ...
         user_location.pincode, user_location.house_no, user_location.receiver_name, user_location.receiver_mobile, store_login.user_fullname as store_name  from sale 
