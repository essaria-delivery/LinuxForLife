    ...
    <div class="wrapper">
        ...
        ?>>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="card-content">
                                    ...
                                    <a class="pull-left" href="<?php echo site_url("admin/add_product"); ?>"><?php echo $this->lang->line("ADD");?></a>
            ...
            <td><?php if($product->product_image!=""){ ?><div class="cat-img" style="width: 50px; height: 50px;">
              <img width="100%" height="100%" src="<?php echo $img.'/uploads/products/'.$product->product_image; ?>" /></div> <?php } ?></td>
                                                <td>
