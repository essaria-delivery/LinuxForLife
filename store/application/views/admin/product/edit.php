                                    ...
                                    <h4 class="card-title"><?php echo $this->lang->line("Edit products");?></h4>
                                        ...
                                        <div class="row" style="margin-top: 50px">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty" style="margin-top: -10px">
                                                    <textarea name="product_description" class="textarea" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd;  " required><?php echo $product->product_description; ?></textarea>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail">
                                                        <img width="100%" height="100%" src="<?= $base.'uploads/products/'.$product->product_image; ?>" />
                                                    </div>
                                        ...
                                        <div class="row" style="margin-top: 50px">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty" style="margin-top: -10px">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="mrp"  class="form-control" value="<?php echo $product->mrp; ?>" placeholder="00.00" required/>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 50px">
