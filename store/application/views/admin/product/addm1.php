                        ...
                        <div class="col-md-9">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <h4 class="card-title"><?php echo $this->lang->line("Purchase Product");?></h4>
                                    <div class="row" style="margin-top: 50px">
                                            <?php
                                            $purchases->product_id;
                                            $purchases->product_name;
                                            ?>
                                            <label class="col-md-3 "><?php echo $this->lang->line("ID");?> *</label>
                                            
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty" style="margin-top: -10px">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="product_id" value="<?php echo $purchases->product_id; ?>" class="form-control">
                                    ...
                                    <!--...-->
                                        <div class="row" style="margin-top: 50px">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty" style="margin-top: -10px">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="product_title" value="<?php echo $purchases->product_name; ?>" class="form-control">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button" style="margin-top: -10px;">
                                                    <input type="submit" class="btn btn-fill btn-rose" name="addcatg" value="<?php echo $this->lang->line("Add Purchase");?>">
                                                </div>
                                            </div>
                                        </div>
                                </div>
