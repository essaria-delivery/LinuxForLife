                            ...
                            <div class="card">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <!--<select class="form-control" name="product_id">-->
                                                <?php foreach($products as $product){
                                                    ?>
                                                     <?php if($product->product_id == $purchase->product_id) { ?><input type="text" name="product_name"  value="<?php echo $product->product_name; ?>"  class="form-control" placeholder="00" />
                                        ...
                                        <div class="row">
                                        <div class="form-group" style="margin-right: 72px;">
                                            <label class=""><b><?php echo $this->lang->line("Qty :");?> </b><span class="text-danger">*</span></label>
                                            <div class="col-md-12">
                                                
                                              <div class="col-md-5" style="margin-top: -1px;float: left;">  
                                              <label class=""><?php echo $this->lang->line("Prev");?> <span class="text-danger"></span></label>
                                            <input type="text" name="qty"  value="<?php echo $purchase->qty; ?>"  placeholder="00" readonly />
                                            </div>
                                            <div class="col-md-1" style="margin-top: -13px;" ><h2>+</h2></div>
                                            <div class="col-md-5" style="margin-top: -1px;"> 
                                            <label class=""><?php echo $this->lang->line("New");?> <span class="text-danger"></span></label>
                                             <input type="text" name="new_qty" class="form-control" value="<?php echo $purchase->qty; ?>" style="margin: -10px 2px !important;"placeholder="00" /></div>
                                        </div>
                                        </div>
                                        </div>
                                        <!--   <div class="form-group">-->
                                        <!--    <label class=""><?php echo $this->lang->line("New Stock :");?> <span class="text-danger">*</span></label>-->
                                        <!--    <input type="text" name="new_qty"  value="<?php echo $purchase->qty; ?>"  class="form-control" placeholder="00"  />-->
