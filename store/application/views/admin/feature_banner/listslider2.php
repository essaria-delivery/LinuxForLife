                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="card-content">
                                    ...
                                    <a class="pull-left" href="<?php echo site_url("admin/add_feature_Banner"); ?>"><?php echo $this->lang->line("ADD");?></a>
                                    ...
                                    <div class="material-datatables">
                                        <table id="example" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tfoot>
                                             ...
                                             <tbody><?php foreach($allslider as $bus){ ?>
                                                    <tr>
                                                        <td class="text-center"><?php echo $bus->slider_title; ?></td>
                                                        <td class="text-center"><?php echo $bus->slider_url; ?></td>
                                                        <td class="text-center" align="center"><div class="cat-img" style="width: 200px;"><img width="100%" height="100%" src="<?php echo $this->config->item('base_url').'uploads/sliders/'.$bus->slider_image ?>" /></div></td> 
