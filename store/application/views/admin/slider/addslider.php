                        ...
                        <div class="col-md-9">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title"><?php echo $this->lang->line("Add Slider");?></h4>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button" style="margin-top: -10px;">
                                                    <input type="submit" class="btn btn-fill btn-rose" name="addslider" value="<?php echo $this->lang->line("Add Slider");?>">
                                                </div>
                                            </div>
                                        </div>
                                </div>
