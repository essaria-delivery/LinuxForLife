                        ...
                        <div class="col-md-9">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title"><?php echo $this->lang->line("Edit Slider");?></h4>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button">
                                                    <input type="submit" name="saveslider" value="<?php echo $this->lang->line("Add Slider");?>"  class="btn btn-fill btn-rose" />
                                                </div>
                                            </div>
                                        </div>
                                </div>
