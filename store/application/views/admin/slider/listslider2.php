            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <!--start mine-->
                        <div class="card-content">
                                    <h4 class="card-title"><?php echo $this->lang->line("All Main Slider");?></h4>
                                    <a class="button" href="<?php echo site_url("admin/addslider"); ?>"><?php echo $this->lang->line("ADD");?></a>
                                             ...
                                             <tbody>
                                                <?php foreach($allslider as $bus){ ?>
                                                    <tr>
                                                        ...
                                                        <td class="cat-img" align="center"><div class="cat-img" style="width: 200px;"><img width="200%" height="100%" src="<?php echo $img.'uploads/sliders/'.$bus->slider_image ?>" /></div></td> 
                                                        ...
                                                        <td class="td-actions text-right"><div class="">
                                                            <?php echo anchor('admin/editslider/'.$bus->id,  '<button type="button" rel="tooltip" class="btn btn-success btn-round">
                                                                <i class="material-icons">edit</i>
                                                            </button>', array("class"=>"")); ?>

                                                            <?php echo anchor('admin/deleteslider/'.$bus->id,  '<button type="button" rel="tooltip" class="btn btn-danger btn-round">
