                                    ...
                                    <div class="form-group" style="display:none;">
                                        ...
                                        <div class="row" style="margin-top: 50px">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty" style="margin-top: -10px">
                                                    ...
                                                    <input type="text" id="user_fullname" name="emp_fullname" value="<?php echo $user->user_name; ?>" placeholder="Delivery Boy Name" class="form-control" required/>
                                        ...
                                        <div class="row" style="margin-top: 50px">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty" style="margin-top: -10px">
                                                    <label class="control-label"></label>
                                                    <input type="password" value="<?php echo $user->user_name; ?>" class="form-control" id="user_password" name="user_password" placeholder="password" required/>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 50px">
