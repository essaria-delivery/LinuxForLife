                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title"><?php echo $this->lang->line("Complain");?>:</h4>
                                       ...
                                       <table id="example" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            <thead>
                                                 <tr>
                                                    ...
                                                    <th><?php echo $this->lang->line("User_Contact");?></th>
                                            ...
                                            <tbody>
												  <?php foreach($comp as $complain){ ?>
                                                <tr>
                                                    <td class="text-center"><?php echo $complain->id; ?></td>
                                                    <td><?php echo $complain->user_name; ?></td>
                                                    <td><?php echo $complain->user_contact; ?></td>
                                                   <td><?php echo $complain->product_name; ?></td>
                                                               <td><?php if($complain->product_image!=""){ ?><div class="cat-img" style="width: 50px; height: 50px;">
              <img width="100%" height="100%" src="<?= $base.'uploads/products/'.$complain->product_image; ?>" /></div> <?php } ?></td>
                                                   <!--<td><?php echo $complain->product_image; ?></td>-->
                                                   <td><?php echo $complain->complain; ?></td>
                                                  
                                                     <!--start icond of delete and edit cat-->
                                                    
                                                    <!-- <td class="td-actions text-right"><div class="btn-group">-->
                                                    <!--        <?php echo anchor('admin/editcategory/'.$complain->id, '<button type="button" rel="tooltip" class="btn btn-success btn-round">-->
                                                    <!--        <i class="material-icons">edit</i>-->
                                                    <!--    </button>', array("class"=>"")); ?>-->

                                                    <!--        <?php echo anchor('admin/deletecat/'.$complain->id, '<button type="button" rel="tooltip" class="btn btn-danger btn-round">-->
