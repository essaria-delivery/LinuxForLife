...
<div class="sidebar" data-active-color="rose" data-background-color="black" data-image="<?php echo base_url($this->config->item("new_theme")."/assets/img/sidebar-1.jpg"); ?> " <?php if($this->session->userdata('language') == "arabic"){ echo 'style="left: unset;right: 0"'; } ?> >
	...
	$(function(){
		...
		$('.nav a').click(function(){
                ...
                <div class="user">
                    <div class="photo">
                        <?php
                          ...
                          $row=$q->row();
                          $url=str_replace('store','uploads/profile',base_url());
                        ?>
                        <img src="<?= $url.$row->user_image; ?>" />
                        
                    </div>
                    <div class="info">
                        <a data-toggle="collapse" href="#collapseExample" class="collapsed">
                            <?= _get_current_user_name($this); ?>
                            <b class="caret"></b>
                        </a>
                        <div class="collapse" id="collapseExample">
                            <ul class="nav">
                                ...
                                <li>
                                    <a href="<?php echo site_url("admin/edit_store_user/"._get_current_user_id($this)); ?>" ><?php echo $this->lang->line("Edit Profile");?></a>
                                </li>
                                <li>
            ...
            <li>
                <a href="<?php echo site_url("admin/listcategories_store"); ?>">
            ...
            <li>
              <a href="<?php echo site_url("admin/stock"); ?>">
                <i class="fa fa-sticky-note-o"></i> <span> <?php echo $this->lang->line("Stock Alerts");?></span> <small class="label pull-right bg-green"></small>
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="<?php echo site_url("admin/list_commision/0"); ?>">
                <i class="material-icons">restaurant_menu</i> 
                <p> <?php echo $this->lang->line("Commission");?></p> 
            ...
            <li>
              <a href="<?php echo site_url("admin/complain"); ?>">
                <i class="material-icons">restaurant_menu</i> 
                <p> <?php echo $this->lang->line("Complain");?></p> 
               
              </a>
            </li>
             <li>
              <a href="<?php echo site_url("admin/delivery_charge"); ?>">
                <i class="fa fa-users"></i> <span> <?php echo 'Delivery Charge' ;?></span> 
            ...
            <!--    <i class="fa fa-bell"></i> <span> <?php echo $this->lang->line("SMS Alert");?></span> <small class="label pull-right bg-green"></small>-->
            <!--  </a>-->
            <!--</li>-->
            <!--<li>-->
            <!--  <a href="<?php echo site_url("admin/socity"); ?>">-->
            <!--    <i class="fa fa-map-signs"></i> <span> <?php echo $this->lang->line("Delivery Areas");?></span> <small class="label pull-right bg-green"></small>-->
            <!--  </a>-->
            <!--</li>-->
            ...
            <!--<li>-->
            <!--  <a href="<?php echo site_url("admin/stock"); ?>">-->
            <!--    <i class="fa fa-sticky-note-o"></i> <span> <?php echo $this->lang->line("Stock Alerts1");?></span> <small class="label pull-right bg-green"></small>-->
            <!--  </a>-->
            <!--</li>-->
         ...
         <!--    <li>
           ...
           <!--  <li>
            ...
            <!--    <i class="fa fa-mobile"></i> <span> <?php echo $this->lang->line("Payment Gateway");?></span> <small class="label pull-right bg-green"></small>-->
            <!--  </a>-->
            <!--</li>-->
            <!-- <li>-->
