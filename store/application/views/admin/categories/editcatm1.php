                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <!--<h4 class="card-title"><?php echo $this->lang->line("Add Categories");?></h4>-->
                                        <div class="row" style="margin-top: 50px">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty" style="margin-top: -10px">
                                                    ...
                                                    <!--start mine-->
                                                    <input type="text" name="cat_title" class="form-control" placeholder="Categories Title" value="<?php echo $getcat->title; ?>" required/>
                                            ...
                                            <div class="col-md-9" style="margin-top: -30px">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <select class="form-control"  name="parent" required>
                                                        <option id="<?= $store ?>" value=""> <?php "No Parent"; ?></option>
                                                <?php  
                                                    echo printCategory(0,0,$this,$getcat,$store);
                                                    function printCategory($parent,$leval,$th,$getcat,$store){
                                                    
                                                    $q = $th->db->query("SELECT a.*, Deriv1.count FROM `categories` a  LEFT OUTER JOIN (SELECT `parent`, COUNT(*) AS count FROM `categories` GROUP BY `parent`) Deriv1 ON a.`id` = Deriv1.`parent` WHERE a.`parent`=" . $parent." AND a.store_id_login=".$store);
                                                    $rows = $q->result();
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left"><?php echo $this->lang->line("Category Image")?>:</label>
                                            <div class="col-md-9">
                                                <legend></legend>
                                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail">
                                                        <img width="100%" height="100%" src="<?= $base.'uploads/category/'.$getcat->image; ?>" />
                                                        <!--<?= $base.'uploads/products/'.$product->product_image; ?>-->
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button">
                                                    <input type="submit" class="btn btn-fill btn-rose" name="savecat" value="<?php echo $this->lang->line("Update Category");?>">
                                                </div>
                                            </div>
                                        </div>
                                </div>
