                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <section class="content-header">
                                         <h4 class="card-title"><?php echo $this->lang->line("Manage Delivery Boy")?>:</h4>
									 <!-- <h3>-->
												 ...
												 <?php foreach($users as $user){
														...
														<tr>
															...
															<td>
																...
																<!--<a href="<?php echo site_url("admin/delete_user/".$user->id); ?>" class="btn btn-danger">-->
																    <!--<i class="fa fa-remove"></i-->
																<!--    </a>-->
																<!--<a href="<?php echo site_url("admin/edit_user/".$user->id); ?>" class="btn btn-danger"><i class="fa fa-edit"></i></a>-->
																
																
																<div class="btn-group">
                                                            <?php echo anchor('admin/edit_user/'.$user->id, '<button type="button" rel="tooltip" class="btn btn-success btn-round" style="padding: 5px;">
                                                                <i class="material-icons">edit</i>
                                                            </button>', array("class"=>"")); ?>

                                                            <?php echo anchor('admin/delete_user/'.$user->id, '<button type="button" rel="tooltip" class="btn btn-danger btn-round" style="padding: 5px;">
