                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <a class="button" style="" href="<?php echo site_url("admin/add_coupons"); ?>">
                                            ...
                                            <thead>
                                                 <tr>
                                                   <th class="text-center"><?php echo $this->lang->line("S.No");?></th>
                                                    ...
                                                    <th class="text-center"><?php echo $this->lang->line("Valid To");?></th>
                                                    
                                                    <th class="text-center"><?php echo $this->lang->line("Discount Value");?></th>
                                                    <th class="text-center"><?php echo $this->lang->line("Cart Value");?></th>
                                                    <th class="text-center"><?php echo $this->lang->line("Uses Resriction");?></th>
                                                ...
                                                <?php foreach($coupons as $coupon){ ?>
                                                    <tr>
                                                        ...
                                                        <td class="td-actions text-right"><div class="">
                                                            <?php echo anchor('admin/editCoupon/'.$coupon->id,  '<button type="button" rel="tooltip" class="btn btn-success btn-round">
                                                                <i class="material-icons">edit</i>
                                                           </button>', array("class"=>"")); ?>

                                                            <?php echo anchor('admin/deleteCoupon/'.$coupon->id,  '<button type="button" rel="tooltip" class="btn btn-danger btn-round">
