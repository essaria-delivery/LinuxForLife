                                        ...
                                        <div class="row" style="margin-top: 50px">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty" style="margin-top: -10px">
                                                    ...
                                                    <input type="text" name="coupon_title" placeholder="Name of The Coupon" class="form-control" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row" style="margin-top: -10px;">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty" style="margin-top: -10px;">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="value"  class="form-control" placeholder="00.00"/>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-top: -10px;">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty" style="margin-top: -10px;">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="cart_value"  class="form-control" placeholder="00"/>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-top: -10px;">
                                            ...
                                            <label class="col-md-3 label-on-left"><?php echo $this->lang->line("Uses Restriction");?> : *</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty" style="margin-top: -10px;">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="restriction" class="form-control" placeholder="00.00"/>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <!--....-->
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button" style="margin-top: -10px;">
                                                    <input type="submit" class="btn btn-fill btn-rose" name="addcatg" value="<?php echo $this->lang->line("ADD COUPON");?>">
                                                </div>
                                            </div>
                                        </div>
                                </div>
