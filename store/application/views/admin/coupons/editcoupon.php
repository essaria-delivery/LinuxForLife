                                        ...
                                        <div class="row" style="margin-top: 50px">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty" style="margin-top: -10px">
                                                    ...
                                                    <input type="text" name="coupon_title" value="<?= $coupon['coupon_name']; ?>" placeholder="Name of The Coupon" class="form-control" />
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-content">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type='text' id='txtDate' name="from" value="<?= $coupon['valid_from']; ?>"  class="form-control datetimepicker" " readonly="">
                                                        <span class="material-input"></span></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-content">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="label-control"></label>
                                                            <input type='text' id="txtDate2" name="to" value="<?= $coupon['valid_to']; ?>" class="form-control datepicker" readonly="">
                                                        <span class="material-input"></span></div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="margin-top: -10px;">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty" style="margin-top: -10px;">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="value"  value="<?= $coupon['discount_value'];?>"   class="form-control" placeholder="00.00"/>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-top: -10px;">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty" style="margin-top: -10px;">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="cart_value" value="<?= $coupon['cart_value'];?>" class="form-control" placeholder="00"/>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-top: -10px;">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty" style="margin-top: -10px;">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="restriction" value="<?= $coupon['uses_restriction'];?>"  class="form-control" placeholder="00.00"/>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <!--....-->
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button" style="margin-top: -10px;">
                                                    <input type="submit" class="btn btn-fill btn-rose" name="addcatg" value="<?php echo $this->lang->line("Update Coupon");?>">
                                                </div>
                                            </div>
                                        </div>
                                </div>
