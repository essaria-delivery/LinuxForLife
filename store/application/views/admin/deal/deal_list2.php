                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title"><?php echo $this->lang->line("Deal Product List");?>:</h4>
                                    <a class="button" style="" href="<?php echo site_url("admin/add_dealproduct"); ?>">
                                            ...
                                            <thead>
                                                 <tr>
                                                   <th class="text-center"><?php echo $this->lang->line("Product Name");?></th>
                                                    ...
                                                    <th class="text-center"><?php echo $this->lang->line("Start Time");?></th>
                                                    <th class="text-center"><?php echo $this->lang->line("End Date");?></th>
                                                    <th class="text-center"><?php echo $this->lang->line("End Time");?></th>
                                                    <th class="text-center"><?php echo $this->lang->line("Expire");?></th>
                                           ...
                                           <tbody>
                                                <?php foreach($deal_products as $product){ ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo $product->start_date; ?></td>
                                                        <td class="text-center"><?php echo $product->start_time; ?></td>
                                                        <td class="text-center"><?php echo $product->end_date; ?></td>
                                                        <td class="text-center"><?php echo $product->end_time; ?></td>
                                                        <?php 
                                                        ...
                                                        <?php if($date1 <= $present && $present <=$date2)
                                                                        { echo 'Running'; }
