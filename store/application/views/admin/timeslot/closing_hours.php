                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="date" class="form-control datepicker" autocomplete="off"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="form-group">
                                                <label class="label-control"></label>
                                                <input type="time" name="opening_time" class="form-control timepicker"  />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="form-group">
                                                <label class="label-control"></label>
                                                <input type="time" name="closing_time" class="form-control timepicker"  />
                                            </div>
                                        </div>
                                    </div>
                                </div>
