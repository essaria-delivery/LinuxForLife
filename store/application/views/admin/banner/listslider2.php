            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <!--start mine-->
                        <div class="card-content">
                                    <h4 class="card-title"><?php echo $this->lang->line("All Secondary Slider");?></h4>
                                    <a class="button" href="<?php echo site_url("admin/add_Banner"); ?>"><?php echo $this->lang->line("ADD");?></a>
                                            ...
                                            <tfoot>
                                             ...
                                             <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="cat-img" align="center"><div class="cat-img" style="width: 200px;"><img width="100%" height="100%" src="<?php echo $img.'uploads/sliders/'.$bus->slider_image ?>" /></div></td> 
