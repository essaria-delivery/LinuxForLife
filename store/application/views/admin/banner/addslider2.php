                        ...
                        <div class="col-md-9">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title"><?php echo $this->lang->line("Add Secondary Slider");?></h4>
                                        <div class="row" style="margin-top: 50px">
                                            <label class="col-md-3 "><?php echo $this->lang->line("Slider Title");?> *</label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="row" >
                                            ...
                                            <div class="col-md-9" >
                                                <legend></legend>
                                                <div class="fileinput fileinput-new text-center" data-provides="fileinput" style="margin-top: -10px" >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button" style="margin-top: -10px;">
                                                    <input type="submit" class="btn btn-fill btn-rose" name="addslider" value="<?php echo $this->lang->line("Add Banner");?>">
                                                </div>
                                            </div>
                                        </div>
                                </div>
