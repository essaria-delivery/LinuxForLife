                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center"><?php echo $this->lang->line("Page Slug");?></th>
                                            ...
                                            <tbody>
                                                <?php foreach($allpages as $allpage){ ?>
                                                    <tr>
                                                        ...
                                                        <!--    <?php echo anchor('admin/editpage_app/'.$allpage->id, '<button type="button" rel="tooltip" class="btn btn-success btn-round">-->
                                                        <!--        <i class="material-icons">edit</i>-->
                                                        <!--    </button>', array("class"=>"")); ?>-->

                                                        <!--    <?php echo anchor('admin/deletepage/'.$allpage->id, '<!--button type="button" rel="tooltip" class="btn btn-danger btn-round">-->
