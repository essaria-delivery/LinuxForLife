                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title"><?php echo $this->lang->line("All Banners");?></h4>
                                    <a class="pull-right" href="<?php echo site_url("admin/add_Banner"); ?>"><?php echo $this->lang->line("ADD");?></a>
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center"><?php echo $this->lang->line("Slider Url");?></th>
                                            ...
                                            <tbody>
                                                <?php foreach($allslider as $bus){ ?>
                                                    <tr>
                                                        <td class="text-center"><?php echo $bus->slider_title; ?></td>
                                                        <td class="text-center"><?php echo $bus->slider_url; ?></td>
                                                        <td class="text-center" align="center"><div class="cat-img" style="width: 500px;"><img width="100%" height="100%" src="<?php echo $this->config->item('base_url').'uploads/sliders/'.$bus->slider_image ?>" /></div></td> 
                                                        <td class="text-center"><?php if($bus->slider_status=="1"){echo "Active";}else{echo "DeActive";} ?></td>
                                                        
                                                        <td class="td-actions text-center"><div class="">
                                                            <?php echo anchor('admin/edit_banner/'.$bus->id,  '<button type="button" rel="tooltip" class="btn btn-success btn-round">
                                                                <i class="material-icons">edit</i>
                                                            </button>', array("class"=>"")); ?>

                                                            <?php echo anchor('admin/delete_banner/'.$bus->id,  '<button type="button" rel="tooltip" class="btn btn-danger btn-round">
