		...
		$('.nav a').click(function(){
            ...
            <div class="sidebar-wrapper">
                    ...
                    <div class="info">
                        ...
                        <div class="collapse" id="collapseExample">
                            <ul class="nav">
                                ...
                                <li>
                                    <a href="<?php echo site_url("users/edit_mainuser/".$z); ?>" ><?php echo $this->lang->line("Edit Profile");?></a>
                                </li>
                                <li>
                ...
                <ul class="nav ">
                    ...
                    <li class="">
                        <a href="<?php echo site_url("users/author"); ?>">
                            <i class="material-icons">supervised_user_circle</i>
                            <p><?php echo $this->lang->line("Authors");?></p>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo site_url("users"); ?>">
                            <i class="material-icons">store_mall_directory</i>
                            <p><?php echo $this->lang->line("Store Management");?></p>
                        </a>
                    </li>
                    <!--<li>-->
                    <!--    <a href="<?php echo site_url("users/all_plans"); ?>">-->
                    <!--        <i class="material-icons">star</i>-->
                    <!--        <p><?php echo $this->lang->line("MemberShip Plans");?></p>-->
                    <!--    </a>-->
                    <!--</li>-->
                    <li>
                        <a href="<?php echo site_url("admin/list_app_home_banner"); ?>">
                            <i class="material-icons">photos</i>
                            <p><?php echo "Home Banners";?></p>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo site_url("admin/allpageapp"); ?>">
                    ...
                    <li class="">
                        <a href="<?php echo site_url("admin/sms_new"); ?>">
                            <i class="material-icons">textsms</i>
                            <p><?php echo $this->lang->line("Setting");?></p>
                        </a>
                    </li>
                    <!--<li class="">-->
                    <!--    <a href="<?php echo site_url("admin/sms"); ?>">-->
                    <!--        <i class="material-icons">textsms</i>-->
                    <!--        <p><?php echo $this->lang->line("SMS Alert");?></p>-->
                    <!--    </a>-->
                    <!--</li>-->
                    <!--<li>-->
