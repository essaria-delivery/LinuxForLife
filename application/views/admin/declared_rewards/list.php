                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="socity_name" class="form-control" placeholder="<?php echo $this->lang->line("Socity Name :");?>"/>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="box-footer">
                                        <input type="submit" class="btn btn-primary" name="addcatg" value="<?php echo $this->lang->line("Add Society");?>" />
