                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <a class="pull-right" href="<?php echo site_url("admin/add_app_home_banner"); ?>"> <?php echo $this->lang->line("ADD");?></a>
                                    <div class="toolbar">
                                    ...
                                    <div class="material-datatables">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php $i=1; foreach($slider as $coupon){ ?>
                                                    <tr>
                                                        <td class="text-center"><?= $i; ?></td>
                                                        <td class="text-center"><?= $coupon->slider_title; ?></td>
                                                        <td class="text-center"><img src="<?=  base_url()."uploads/sliders/".$coupon->slider_image; ?>"></td>
                                                        <td class="text-center"><input type="checkbox" <?php if($coupon->slider_status=='1'){ echo "checked"; } ?> name="" disabled> </td>
                                                        <td class="td-actions text-right"><div class="">
                                                            <?php echo anchor('admin/edit_app_home_banner/'.$coupon->id,  '<button type="button" rel="tooltip" class="btn btn-success btn-round">
                                                                <i class="material-icons">edit</i>
                                                            </button>', array("class"=>"")); ?>

                                                            <?php echo anchor('admin/delete_app_home_banner/'.$coupon->id,  '<button type="button" rel="tooltip" class="btn btn-danger btn-round">
