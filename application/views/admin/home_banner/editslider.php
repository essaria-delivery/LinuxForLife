                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="text" name="slider_title" class="form-control" placeholder="<?php echo $this->lang->line("Slider Title");?>" value="<?= $slider->slider_title ?>"/>
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail">
                                                        <img width="100%" height="100%" src="<?= base_url()."uploads/sliders/".$slider->slider_image ?>">
                                                    </div>
                                   ...
                                   <h4 class="card-title"><?php echo $this->lang->line("Add Banner");?></h4>
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="slider_title" class="form-control" placeholder="<?php echo $this->lang->line("Slider Title");?>" />
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button">
                                                    <input type="submit" name="addslider" value="<?php echo $this->lang->line("Add Banner");?>" class="btn btn-fill btn-rose" >                                                </div>
                                            </div>
                                        </div>
                                </div>
                            </div>
