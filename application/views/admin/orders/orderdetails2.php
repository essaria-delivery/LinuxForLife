                                    ...
                                    <div class="material-datatables">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <tr>
                                                    <td ><strong class="pull-left">Use Coupon : <?php if($order->coupon_code=="0" || $order->coupon_code==""){ echo "N/A"; }else { echo $order->coupon_code; } ?> </strong>
                                                    </td>
                                                    <td ><strong class="pull-right"> <?php echo $this->lang->line("Total :");?></strong>
                                                    </td>
                                                    <td >
                                                ...
                                                <tr>
                                                    <td><strong class="pull-left">Discount : <?php if($order->coupon_code=="0" || $order->coupon_code==""){ echo "N/A"; }else { echo $order->used_amount; } ?> </strong>
                                                    </td>
                                                    <td><strong class="pull-right"><?php echo $this->lang->line("Delivery Charges");?> :</strong></td>
                                                    <td >
                                                ...
                                                <tr>
                                                    ...
                                                    <td >
                                                        <strong class=""><?php echo $net = $order->total_amount + $order->delivery_charge; ?><?php echo $this->config->item("currency");?> </strong>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
