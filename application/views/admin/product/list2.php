                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <!--        MINE              -->
                                    <a class="pull-right" href="<?php echo site_url("admin/add_product"); ?>" style="margin:  0px 30px 10px 0px;padding: 0px 10px;border: 1px solid;" ><?php echo $this->lang->line("ADD OTHER");?></a>
                                    <!--        MINE              -->
