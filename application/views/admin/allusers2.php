                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo $this->lang->line("Total Rewards");?></th>
                                                  ...
                                                  foreach($users as $user)
                                                  {
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <!--<?php echo anchor('admin/user_action/'.$user->user_id,  '<button type="button" rel="tooltip" class="btn btn-success btn-round">-->
