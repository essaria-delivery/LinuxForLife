                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title"><?php echo $this->lang->line("Edit Store");?> </h4>
                                        <div class="row" style="padding-top: 50px;">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="text" name="emp_fullname" class="form-control" placeholder="<?php echo $this->lang->line("Sub-Admin Name");?>" value="<?php echo $user->user_name; ?>" />
                                        ...
                                        <!--        <div class="form-group label-floating is-empty">-->
                                        <!--            <label class="control-label"></label>-->
                                        <!--            <input type="text" name="user_fullname" class="form-control" placeholder="<?php echo $this->lang->line("Sub-Admin Name");?>" value="<?php echo $user->user_fullname; ?>" />-->
                                        <!--        <span class="material-input"></span></div>-->
                                        <!--    </div>-->
                                        <!--</div>-->
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <select name="city"  class="form-control">
                                                        ...
                                                        ?>
                                                        <option value="<?= $city->city_id ?>" <?php if($city->city_id==$user->user_city){ echo "selected"; } ?> >
                                                            <?= $city->city_name ?>
                                                            (<?= $city->city_id ?> = <?php echo $user->user_city; ?>)
                                                        </option>
                                                        <?php } ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="fileinput text-center fileinput-new" data-provides="fileinput">
                                                ...
                                                <div>
                                                    ...
                                                    <br>
                                                    <a href="#pablo" class="btn btn-danger btn-round fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times"></i> Remove<div class="ripple-container"><div class="ripple ripple-on ripple-out" style="left: 58.6719px; top: 35px; background-color: rgb(255, 255, 255); transform: scale(15.5488);"></div></div>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
