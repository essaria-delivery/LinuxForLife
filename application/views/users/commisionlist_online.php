    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
         <form role="form" method="post" action="<?= site_url("users/pay_from_store/".$online->store_id)?>">
        <div class="col-md-9">
            <div class="form-group label-floating is-empty" style="margin-top: -10px">
                ...
                <input type="hidden" name="amount" value="<?php echo $online->Admin_Share?>"/>
