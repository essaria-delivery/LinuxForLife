                        ...
                        <div class="col-md-9">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title"><?php echo $this->lang->line("Edit Store");?> </h4>
                                        ...
                                        <div class="row">
                                             ...
                                             <div class=" pac-card col-md-9" >
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input id="searchInput"  type="text"  name="city" class="form-control" placeholder="Enter a location" value="<?php echo $user->user_city; ?>">
                                    ...
                                    <!--<div class="row">-->
                                    <!--        <label class="col-md-3 label-on-left"><?php echo $this->lang->line("Profit Percent");?>: *</label>-->
                                    <!--        <div class="col-md-3">-->
                                    <!--            <div class="form-group label-floating is-empty">-->
                                    <!--                <label class="control-label"></label>-->
                                                    <!--<input type="text" class="form-control" name="percent" placeholder="<?php echo $this->lang->line("Profit Percent");?>" />-->
                                                    <!--<select>-->
                                                    <!--    <option>- - Select Commission Type - -</option>-->
                                                    <!--    <option value=""></option>-->
                                                    <!--    <option value=""></option>-->
                                                    <!--</select>-->
                                    <!--                <select name="account_type" class="form-control"  onchange="if (this.selectedIndex==1){this.form['other'].style.display='block'; this.form['plan'].style.display='none'}else if(this.selectedIndex==2){this.form['plan'].style.display='block'; this.form['other'].style.display='none'}else{this.form['other'].style.display='none'; this.form['plan'].style.display='none'}; ">-->
                                    <!--                    <option value="" selected="selected">Select...</option>-->
                                    <!--                    <option value="percentage" <?php if($user->account_type=="percentage"){ echo "selected"; } ?>>ADMIN SHARES</option>-->
                                    <!--                    <option value="plan" <?php if($user->account_type=="plan"){ echo "selected"; } ?>>PLANS</option>-->
                                    <!--                </select>-->
                                    <!--            <span class="material-input"></span></div>-->
                                    <!--        </div>-->
                                    <!--        <div class="col-md-3">-->
                                    <!--            <div class="form-group label-floating is-empty">-->
                                    <!--                <input  type="text"  name="other" style="display:none;" class="form-control" placeholder="Share As Percentage">-->
                                    <!--                <select name="plan" style="display:none;" class="form-control">-->
                                    ...
                                    <!--    </div>-->
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text"  class="form-control" value="<?php echo $user->profit_percent; ?>"  name="profid" placeholder="user@gmail.com" >
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left"><?php echo $this->lang->line("Delivery Range");?> : *</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input class="form-control" type="number" value="<?php echo $user->delivery_range; ?>"  name="delivery_range" placeholder="Delivery Range" >
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="fileinput text-center fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail img-circle">
                                                    <img src="<?php echo $this->config->item('base_url').'uploads/profile/'.$user->user_main_banner ?>" alt="">
                                                </div>
                                                <div class="fileinput-preview fileinput-exists thumbnail img-circle" style=""></div>
                                                <div>
                                                    <span class="btn btn-round btn-rose btn-file">
