                                                ...
                                                <?php foreach($users as $user){ ?>
                                                    <tr>
                                                       ...
                                                       <td class="td-actions text-center"><div class="btn-group">
                                                            <?php echo anchor('users/edit_user/'.$user->user_id, '<button type="button" rel="tooltip" class="btn btn-success btn-round">
                                                            ...
                                                            <?php $id=$user->user_id;?>
                                                            <?php echo anchor('users/list_commision/'.$id, '<button type="button" rel="tooltip" class="btn btn-success btn-round">
                                                                <i class="material-icons">file_copy</i>
                                                            </button>', array("class"=>"")); ?>
                                                            
                                                                
                                                            </div>
                                                            <?php echo anchor('admin/orders/'.$id, '<button type="button" rel="tooltip" class="btn btn-success">
