                            ...
                            <div class="card">
                               ...
                               <?php if(isset($error) && $error!=""){ echo $error; } ?>
                                <div class="card-content">
                                    <h4 class="card-title"><?php echo $this->lang->line("Add Plans");?></h4>
                                        ...
                                        <div class="row"  style="padding-top:50px;">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="text" name="Plan_Name" class="form-control" placeholder="<?php echo $this->lang->line("Plan Name");?>" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text"  class="form-control" name="Plan_Amount" placeholder="<?php echo $this->lang->line("Plan Amount");?>"  />
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input class="form-control" type="text" name="Plan_Time" placeholder="<?php echo $this->lang->line("Plan Time"); ?>" />
                                                <span class="material-input"></span></div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group label-floating is-empty">
