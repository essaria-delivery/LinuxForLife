                                ...
                                <div class="card-content">
                                    <h4 class="card-title"><?php echo $this->lang->line("Edit Store");?> </h4>
                                        <div class="row"  style="padding-top:50px;">
                                            <label class="col-md-3 label-on-left"><?php echo $this->lang->line("Plan Name");?> : *</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="Plan_Name" class="form-control" placeholder="<?php echo $this->lang->line("Plan Name");?>" value="<?= $user->plan_name ?>" />
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left"><?php echo $this->lang->line("Plan Description");?> : *</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <textarea type="text" name="Plan_Description" class="form-control" placeholder="<?php echo $this->lang->line("Plan Name");?>" 
                                                    style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd;  "/><?= $user->plan_desc ?></textarea>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        
                                        <div class="row">
                                            <label class="col-md-3 label-on-left"><?php echo $this->lang->line("Plan Amount");?> : * </label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text"  class="form-control" name="Plan_Amount" placeholder="<?php echo $this->lang->line("Plan Amount");?>"  value="<?= $user->plan_amount ?>" />
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        
                                        <div class="row">
                                            <label class="col-md-3 label-on-left"><?php echo $this->lang->line("Plan Time"); ?> : *</label>
                                            <div class="col-md-6">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input class="form-control" type="text" name="Plan_Time" placeholder="<?php echo $this->lang->line("Plan Time"); ?>" value="<?= $user->plan_time ?>" />
                                                <span class="material-input"></span></div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <select class="form-control" name="plan_type"  />
                                                        <option value="1" <?php if($user->plan_time_type==1){ echo "selected"; } ?> >Days</option>
                                                        <option value="2" <?php if($user->plan_time_type==2){ echo "selected"; } ?>>Week</option>
                                                        <option value="3" <?php if($user->plan_time_type==3){ echo "selected"; } ?>>Month</option>
                                                        <option value="4" <?php if($user->plan_time_type==4){ echo "selected"; } ?>>Year</option>
                                                    </select>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
