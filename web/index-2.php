...
<!-- Mirrored from askbootstrap.com/preview/osahan-grocery/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Jul 2018 06:47:00 GMT -->
<head>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
      <meta name="description" content="Askbootstrap">
      <meta name="author" content="Askbootstrap">
      <title>Osahan Grocery - Bootstrap4 Responsive Grocery Light Template</title>
      <!-- Favicon Icon -->
         ...
         <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarText">
               <ul class="navbar-nav mr-auto mt-2 mt-lg-0 margin-auto">
                  <li class="nav-item">
                     <a class="nav-link shop" href="index-2.html"><span class="mdi mdi-store"></span> Super Store</a>
                  </li>
				  <li class="nav-item">
                  ...
                  <li class="nav-item">
                     <a class="nav-link" href="shop.html">Home & Kitchen</a>
                  </li>
