         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-3 col-md-3">
                  <h4 class="mb-5 mt-0"><a class="logo" href="index-2.php"><img src="img/logo-footer.png" alt="Osahan Grocery"></a></h4>
                  ...
                  <p class="mb-0"><a class="text-success" href="#"><i class="mdi mdi-email"></i> support@gmail.com</a></p>
                  <p class="mb-0"><a class="text-primary" href="#"><i class="mdi mdi-web"></i> support</a></p>
               </div>
         ...
         <div class="container">
            <div class="row no-gutters">
               <div class="col-lg-6 col-sm-6">
                  <p class="mt-1 mb-0">&copy; Copyright 2018 <strong class="text-dark">GoGrocery</strong>. All Rights Reserved<br>
				  <small class="mt-0 mb-0">Made with <i class="mdi mdi-heart text-danger"></i> by <a href="demo.gogrocer.app" target="_blank" class="text-primary">GoGrocer</a>
                  </small>
				  </p>
               </div>
